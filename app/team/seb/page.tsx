        ...
        <div className="mx-auto w-full max-w-5xl">
          <div className="grid gap-6 overflow-hidden rounded-3xl bg-white shadow-2xl lg:grid-cols-2 lg:gap-0">
            <div className="relative aspect-square overflow-hidden lg:aspect-auto">
              <Image src="/images/design-mode/seb-pfp.png" alt="Sebastian Montgomery" fill sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover" priority />
            </div>

            <div className="flex flex-col justify-center p-6 lg:p-8 xl:p-10">
              <h1 className="mb-1 text-3xl font-bold text-foreground lg:text-4xl">Sebastian Montgomery</h1>
              <p className="mb-6 text-lg font-semibold text-muted-foreground lg:text-xl">General Manager</p>
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <span className="font-medium text-foreground">seb@validator.com</span>
                </a>

                <a
                  href="https://twitter.com/SebMontgomery"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-3 rounded-xl bg-gray-50 p-3 transition-colors hover:bg-gray-100"
                >
                  <Twitter className="h-5 w-5 text-brand-cyan" />
                  <span className="font-medium text-foreground">@SebMontgomery</span>
                </a>

                <a
                  href="https://www.linkedin.com/in/sebastian-montgomery-3354a245/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-3 rounded-xl bg-gray-50 p-3 transition-colors hover:bg-gray-100"
                >
